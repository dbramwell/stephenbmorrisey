    ...
    return (
      <div className='page'>
        ...
        <div className='series-links-container'>
          <SeriesLink id='thrillers' header='The Russian Thrillers' description={thrillersDesc} animation='fadeInLeft' />
          <SeriesLink id='eagle' header='The Black Eagle Trilogy' description={eagleDesc} animation='fadeInUp' />
          <SeriesLink id='tales' header='The Russian Tales' description={talesDesc} animation='fadeInRight' />
        </div>
      </div>
    )
  }
